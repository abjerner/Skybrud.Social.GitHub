...
public class GitHubTeam : GitHubTeamBase {
    ...
    protected GitHubTeam(JObject json) : base(json) {
        ...
        MembersCount = json.GetRequiredInt32("members_count");
        ReposCount = json.GetRequiredInt32("repos_count");
        Organization = json.GetRequiredObject("organization", GitHubOrganization.Parse);
    }
