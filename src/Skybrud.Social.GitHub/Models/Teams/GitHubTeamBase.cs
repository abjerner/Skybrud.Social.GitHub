...
/// </summary>
public class GitHubTeamBase : GitHubObject {
    ...
    protected GitHubTeamBase(JObject json) : base(json) {
        Name = json.GetRequiredString("name");
        Id = json.GetRequiredInt32("id");
        NodeId = json.GetRequiredString("node_id");
        Slug = json.GetRequiredString("slug");
        Description = json.GetString("description"); // TODO: is this property nullable? or just "" if not set?
    ...
    /// <summary>
    /// Parses the specified <paramref name="json"/> into an instance of <see cref="GitHubTeamBase"/>.
    /// </summary>
