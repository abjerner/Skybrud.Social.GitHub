...
/// <summary>
/// Class representing the raw <strong>Organization / Teams</strong> endpoint.
/// </summary>
public class GitHubOrganizationTeamsRawEndpoint {
    ...
    public GitHubOrganizationTeamsRawEndpoint(GitHubOAuthClient client) {
        Client = client;
    }
