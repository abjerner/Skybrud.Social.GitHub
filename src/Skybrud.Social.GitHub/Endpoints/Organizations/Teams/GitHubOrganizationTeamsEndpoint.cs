...
namespace Skybrud.Social.GitHub.Endpoints.Organizations.Teams;

/// <summary>
/// Class representing the <strong>Organizations / Teams</strong> endpoint.
/// </summary>
public class GitHubOrganizationTeamsEndpoint {
    ...
    /// </summary>
    public GitHubOrganizationTeamsRawEndpoint Raw => Service.Client.Organizations.Teams;
    ...
    public GitHubOrganizationTeamsEndpoint(GitHubHttpService service) {
        Service = service;
    }
