...
namespace Skybrud.Social.GitHub.Endpoints.Raw {
    ...
    public class GitHubPullRequestsRawEndpoint {
        ...
        public SocialHttpResponse GetPullRequest(string owner, string repository, int number) {
        ...
        /// <returns>An instance of <see cref="SocialHttpResponse"/> representing the raw response.</returns>
        public SocialHttpResponse GetPullRequests(GitHubGetPullRequestsOptions options) {
