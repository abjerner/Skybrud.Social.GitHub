...
namespace Skybrud.Social.GitHub.Endpoints.Repositories.References;

/// <summary>
/// Class representing the <strong>Repositories / References</strong> endpoint.
/// </summary>
public class GitHubRepositoryReferencesEndpoint {
    ...
    /// </summary>
    public GitHubRepositoryReferencesRawEndpoint Raw => Service.Client.Repositories.References;
    ...
    public GitHubRepositoryReferencesEndpoint(GitHubHttpService service) {
        Service = service;
    }
