...
/// <summary>
/// Class representing the raw <strong>Repositories / References</strong> endpoint.
/// </summary>
public class GitHubRepositoryReferencesRawEndpoint {
    ...
    public GitHubRepositoryReferencesRawEndpoint(GitHubOAuthClient client) {
        Client = client;
    }
