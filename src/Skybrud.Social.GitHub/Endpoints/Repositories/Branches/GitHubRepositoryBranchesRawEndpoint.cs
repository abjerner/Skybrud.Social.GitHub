...
/// <summary>
/// Class representing the raw <strong>Branches</strong> endpoint.
/// </summary>
public class GitHubRepositoryBranchesRawEndpoint {
    ...
    public GitHubRepositoryBranchesRawEndpoint(GitHubOAuthClient client) {
        Client = client;
    }
