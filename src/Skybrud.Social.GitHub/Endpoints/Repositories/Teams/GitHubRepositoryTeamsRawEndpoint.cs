...
/// <summary>
/// Class representing the raw <strong>Repositories / Teams</strong> endpoint.
/// </summary>
public class GitHubRepositoryTeamsRawEndpoint {
    ...
    public GitHubRepositoryTeamsRawEndpoint(GitHubOAuthClient client) {
        Client = client;
    }
