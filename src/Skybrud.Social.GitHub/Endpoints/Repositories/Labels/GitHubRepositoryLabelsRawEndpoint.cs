...
/// <summary>
/// Class representing the raw <strong>Repositories / Labels</strong> endpoint.
/// </summary>
public class GitHubRepositoryLabelsRawEndpoint {
    ...
    public GitHubRepositoryLabelsRawEndpoint(GitHubOAuthClient client) {
        Client = client;
    }
