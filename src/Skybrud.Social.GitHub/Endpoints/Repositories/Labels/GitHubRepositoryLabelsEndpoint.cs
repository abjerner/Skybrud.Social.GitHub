...
namespace Skybrud.Social.GitHub.Endpoints.Repositories.Labels;

/// <summary>
/// Class representing the <strong>Repositories / Labels</strong> endpoint.
/// </summary>
public class GitHubRepositoryLabelsEndpoint {
    ...
    /// </summary>
    public GitHubRepositoryLabelsRawEndpoint Raw => Service.Client.Repositories.Labels;
    ...
    public GitHubRepositoryLabelsEndpoint(GitHubHttpService service) {
        Service = service;
    }
