...
/// <summary>
/// Class representing the <strong>Repositories / Collaborators</strong> endpoint.
/// </summary>
public class GitHubRepositoryCollaboratorsEndpoint {
    ...
    /// </summary>
    public GitHubRepositoryCollaboratorsRawEndpoint Raw => Service.Client.Repositories.Collaborators;
    ...
    public GitHubRepositoryCollaboratorsEndpoint(GitHubHttpService service) {
        Service = service;
    }
