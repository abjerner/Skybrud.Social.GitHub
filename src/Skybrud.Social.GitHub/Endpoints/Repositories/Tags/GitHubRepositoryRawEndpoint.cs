...
/// <summary>
/// Class representing the raw <strong>Repositories / Tags</strong> endpoint.
/// </summary>
public class GitHubRepositoryRawEndpoint {
    ...
    public GitHubRepositoryRawEndpoint(GitHubOAuthClient client) {
        Client = client;
    }
