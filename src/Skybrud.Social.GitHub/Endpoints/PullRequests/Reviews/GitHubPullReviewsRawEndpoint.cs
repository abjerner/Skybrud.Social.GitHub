...
public class GitHubPullReviewsRawEndpoint {
    ...
    public async Task<IHttpResponse> GetReviews(string owner, string repository, int number) {
    ...
    /// <returns>An instance of <see cref="IHttpResponse"/> representing the raw response.</returns>
    public async Task<IHttpResponse> GetReviews(GitHubGetReviewsOptions options) {
