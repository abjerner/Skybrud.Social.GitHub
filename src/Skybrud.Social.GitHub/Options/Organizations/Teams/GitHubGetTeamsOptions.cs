...
public class GitHubGetTeamsOptions : GitHubHttpRequestOptions {
    ...
    public GitHubGetTeamsOptions(int organizationId, int? perPage = null, int? page = null) {
        OrganizationId = organizationId;
        Page = page;
        PerPage = perPage;
    }
    ...
    /// <param name="page">The page to be returned. Default is <c>1</c>, indicating the first page.</param>
    /// <param name="perPage">The maximum amount of pull requests to be returned by each page.</param>
    public GitHubGetTeamsOptions(string organizationAlias, int? perPage = null, int? page = null) {
        OrganizationAlias = organizationAlias;
        Page = page;
        PerPage = perPage;
    }
