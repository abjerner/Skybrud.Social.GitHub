...
public class GitHubGetOrganizationMembersOptions : GitHubHttpRequestOptions {
    ...
    public GitHubGetOrganizationMembersOptions(GitHubOrganizationBase organization) {
    ...
    /// <param name="organization">The organization.</param>
    /// <param name="perPage">The maximum amount of results per page (max is <c>100</c>).</param>
    public GitHubGetOrganizationMembersOptions(GitHubOrganizationBase organization, int? perPage) {
        if (organization == null) throw new ArgumentNullException(nameof(organization));
        OrganizationAlias = organization.Login;
        PerPage = perPage;
    }
    ...
    /// <param name="perPage">The maximum amount of results per page (max is <c>100</c>).</param>
    /// <param name="page">The page to fetch.</param>
    public GitHubGetOrganizationMembersOptions(GitHubOrganizationBase organization, int? perPage, int? page) {
        if (organization == null) throw new ArgumentNullException(nameof(organization));
        OrganizationAlias = organization.Login;
        PerPage = perPage;
        Page = page;
