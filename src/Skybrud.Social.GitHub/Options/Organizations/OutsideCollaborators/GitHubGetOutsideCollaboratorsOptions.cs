...
public class GitHubGetOutsideCollaboratorsOptions : GitHubHttpRequestOptions {
    ...
    /// </summary>
    /// <param name="organizationId">The ID of the organization.</param>
    /// <param name="perPage">The maximum amount of results per page (max is <c>100</c>).</param>
    /// <param name="page">The page to fetch.</param>
    public GitHubGetOutsideCollaboratorsOptions(int organizationId, int? perPage = null, int? page = null) {
        OrganizationId = organizationId;
        PerPage = perPage;
        Page = page;
    }
    ...
    /// <param name="perPage">The maximum amount of results per page (max is <c>100</c>).</param>
    /// <param name="page">The page to fetch.</param>
    public GitHubGetOutsideCollaboratorsOptions(string organizationAlias, int? perPage = null, int? page = null) {
        OrganizationAlias = organizationAlias;
        PerPage = perPage;
        Page = page;
    }
    ...
    /// <param name="perPage">The maximum amount of results per page (max is <c>100</c>).</param>
    /// <param name="page">The page to fetch.</param>
    public GitHubGetOutsideCollaboratorsOptions(GitHubOrganizationItem organization, int? perPage = null, int? page = null) {
        if (organization == null) throw new ArgumentNullException(nameof(organization));
        OrganizationAlias = organization.Login;
        PerPage = perPage;
        Page = page;
    ...
    public override IHttpRequest GetRequest() {
        ...
        // Make sure we have either an organization ID or an alias/login
