...
public class GitHubGetPendingInvitationsOptions : GitHubHttpRequestOptions {
    ...
    [SetsRequiredMembers]
    public GitHubGetPendingInvitationsOptions(string organizationAlias, int? perPage = null, int? page = null) {
        OrganizationAlias = organizationAlias;
        PerPage = perPage;
        Page = page;
    }
    ...
    /// <param name="page">The page to be returned.</param>
    [SetsRequiredMembers]
    public GitHubGetPendingInvitationsOptions(GitHubOrganizationItem organization, int? perPage = null, int? page = null) {
        if (organization == null) throw new ArgumentNullException(nameof(organization));
        OrganizationAlias = organization.Login;
        PerPage = perPage;
        Page = page;
