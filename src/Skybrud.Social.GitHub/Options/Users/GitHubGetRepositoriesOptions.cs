...
public class GitHubGetRepositoriesOptions : GitHubHttpRequestOptions {
    ...
    public GitHubGetRepositoriesOptions(int userId, int? perPage = null, int? page = null) {
        UserId = userId;
        PerPage = perPage;
        Page = page;
    }
    ...
    /// <param name="perPage">The maximum amount of repositories to returned by each page. Maximum is <c>100</c>.</param>
    /// <param name="page">The page to be returned.</param>
    public GitHubGetRepositoriesOptions(string username, int? perPage = null, int? page = null) {
        Username = username;
        PerPage = perPage;
        Page = page;
    }
    ...
    /// <param name="perPage">The maximum amount of repositories to returned by each page. Maximum is <c>100</c>.</param>
    /// <param name="page">The page to be returned.</param>
    public GitHubGetRepositoriesOptions(GitHubUserBase user, int? perPage = null, int? page = null) {
        if (user == null) throw new ArgumentNullException(nameof(user));
        UserId = user.Id;
        PerPage = perPage;
        Page = page;
