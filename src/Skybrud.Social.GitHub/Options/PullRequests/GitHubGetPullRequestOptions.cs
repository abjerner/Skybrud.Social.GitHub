...
public class GitHubGetPullRequestOptions : GitHubHttpRequestOptions {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GitHubGetPullRequestOptions"/> class.
    /// </summary>
    /// <param name="repository">The repository.</param>
    /// <param name="number">The pull request number.</param>
    [SetsRequiredMembers]
    public GitHubGetPullRequestOptions(GitHubRepositoryBase repository, int number) {
